 ...
 * - data stored in the map survives canister ccupgrades unlike using HashMap where data is stored in the heap and it's lost after the canister is upgraded
 *
